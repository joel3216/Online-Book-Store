...
function validateForm() {
	...
	//hardcoded error validation by me 
	else if((x == "Admin" && y=="Admin") || (x == "latha" && y=="123") || (x == "roshan" && y =="micans") || 
	(x == "ajayhs" && y =="ajay") || (x == "abhilash" && y =="123@") || (x == "joel" && y =="1234")){
		null;
	}
...
<center>
    <form name="form1" method="post" action="login_act.php" onsubmit="return validateForm()">
      <table width="913" border="0">
        <tr>
          <td width="564"><img align="center" height="400" width="560" src="img/lib.jpg" /></td>
          <td width="276">
           <table border="0">
                          ...
                          <tr style="color: black">
                            <td height="50" colspan="2"><p align="center">
                              ...
                              <label>
                                <input type="radio" name="user" value="user" id="Student" checked>
                                Customer</label>
                            </p></td>
                          </tr>
                          <tr>
