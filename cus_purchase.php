...
Buy</li>
	...
	<div class="row-fluid">
		...
		<div class="col-md-7">
			...
			<h3>Discount： <?php echo $product['discnt_rate']; ?></h3>
			<h3>Final Price: <?php echo "&nbsp".($product['original_price'] - $product['discnt_rate']).".00"; ?></h3>
...
A total of payment：<span id="totalprice">0</span> Rs</h3>
		...
		<div class="col-md-3">
			<img src="img/<?php echo $imgname; ?>" alt="140x140" width="220" height="300" class="img-polaroid" />
		</div>
	</div>
